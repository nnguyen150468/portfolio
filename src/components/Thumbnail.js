...
export default function Thumbnail() {
    return (
        ...
        <div className="container d-flex align-items-center flex-column">
            ...
            <a id="view-resume" className="masthead-subheading font-weight-light mb-0 mt-5 p-2" href="https://drive.google.com/file/d/1MC3GL0K3V4fa63eIL-SSd2BE0eELkGqI/view?usp=sharing" target="_blank"
